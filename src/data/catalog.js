...
export const productosCuidados = [
  { id:'cd1', name:'Tododia Cereza Negra – Crema 400 ml',     price:8999,  img:'/img/productos/cuidados/cuidados-1.jpg', subcat:'Tododia' },
  { id:'cd2', name:'Tododia Body Splash Cereza Negra 200 ml', price:7999,  img:'/img/productos/cuidados/cuidados-2.jpg', subcat:'Tododia' },
  { id:'cd3', name:'Jabón en barra Tododia (x5)',             price:6499,  img:'/img/productos/cuidados/cuidados-3.jpg', subcat:'Tododia' },
  { id:'cd4', name:'Ekos Mini Jabones Surtidos',              price:6999,  img:'/img/productos/cuidados/cuidados-4.jpg', subcat:'Ekos' },
  { id:'cd5', name:'Ekos Castanha Pulpa corporal 400 ml',     price:9999,  img:'/img/productos/cuidados/cuidados-5.jpg', subcat:'Ekos' },
  { id:'cd6', name:'Tododia Refil 400 ml',                    price:5999,  img:'/img/productos/cuidados/cuidados-6.jpg', subcat:'Tododia' },
];

export const productosMaquillaje = [
  { id:'mq1', name:'UNA Cushion Base',      price:10999, img:'/img/productos/maquillaje/maquillaje-1.jpg', subcat:'UNA' },
  { id:'mq2', name:'UNA Gloss FPS15',       price:6999,  img:'/img/productos/maquillaje/maquillaje-2.jpg', subcat:'UNA' },
  { id:'mq3', name:'FACES Máscara Negra',   price:5499,  img:'/img/productos/maquillaje/maquillaje-3.jpg', subcat:'FACES' },
  { id:'mq4', name:'UNA Máscara Magnífico', price:8499,  img:'/img/productos/maquillaje/maquillaje-4.jpg', subcat:'UNA' },
  { id:'mq5', name:'FACES Labial',          price:5999,  img:'/img/productos/maquillaje/maquillaje-5.jpg', subcat:'FACES' },
  { id:'mq6', name:'UNA Primer Blur',       price:7999,  img:'/img/productos/maquillaje/maquillaje-6.jpg', subcat:'UNA' },
  { id:'mq7', name:'UNA Serum Pestañas',    price:9999,  img:'/img/productos/maquillaje/maquillaje-7.jpg', subcat:'UNA' },
  { id:'mq8', name:'UNA Delineador',        price:6499,  img:'/img/productos/maquillaje/maquillaje-8.jpg', subcat:'UNA' },
];

export const productosRegalos = [
  { id:'rg1', name:'Set Tododia jabones (edición)', price:7999,  img:'/img/productos/regalos/regalos-1.jpg', subcat:'Sets' },
  { id:'rg2', name:'Kaiak Vital Dúo',               price:21999, img:'/img/productos/regalos/regalos-2.jpg', subcat:'Perfumería' },
  { id:'rg3', name:'Kit UNA Mirada',                price:16999, img:'/img/productos/regalos/regalos-3.jpg', subcat:'Maquillaje' },
  { id:'rg4', name:'Spray de ambientes Todanoite',  price:10999, img:'/img/productos/regalos/regalos-4.jpg', subcat:'Hogar' },
  { id:'rg5', name:'Bolsa de regalo Natura',        price:1999,  img:'/img/productos/regalos/regalos-5.jpg', subcat:'Accesorios' },
  { id:'rg6', name:'Set regalo mini',               price:9999,  img:'/img/productos/regalos/regalos-6.jpg', subcat:'Sets' },
];
